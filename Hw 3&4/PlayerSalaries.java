...
public class PlayerSalaries
{
    ...
    public PlayerSalaries(String filename) 
    {
        ...
        salariesArray = new PlayerSalary[salStats];
        readFile.nextLine();
        readFile.nextLine();
        ...
        System.out.println("The file was not found. Please enter 10 to restart the\n"+
        "program and enter different file name.");
    } catch (Exception e){
        System.out.println("Error! Restart and enter proper file name");
    }
}
    ...
    {   
        ...
        try {
        System.out.println("Enter String Player ID: ");
