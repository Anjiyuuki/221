...
public class Library {
   ...
   public static void main (String[] args) throws IOException {
      ...
      int cur = linkedListLibrary.insertSorted(currNode,0);
      ...
      //       the number of operations performed
      int tem = arrayListLibrary.insertSorted(tempBook,0);
      // TODO: Print number of operations for linked list
      System.out.println("Number of linked list operations: "+ cur);
      // TODO: Print number of operations for ArrayList
      System.out.println("Number of ArrayList operations: "+ tem);
}
